            ...
            <div class="flex">
                ...
                @auth
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-jet-nav-link href="{{ route('deudas.index') }}" :active="request()->routeIs('deudas.index')">
                            Deudas
                        </x-jet-nav-link>

                        <x-jet-nav-link href="{{ route('deudas.import') }}" :active="request()->routeIs('deudas.import')">
                            Importar
                        </x-jet-nav-link>
                    </div>
                @endauth
